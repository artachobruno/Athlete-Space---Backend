...
from app.services.integrations.strava.tokens import refresh_access_token
...
def _sync_user_activities(  # noqa: C901, PLR0912
    ...
    if imported_count > 0:
        ...
        try:
            from app.services.metrics.computation_service import trigger_recompute_on_new_activities  # noqa: PLC0415
