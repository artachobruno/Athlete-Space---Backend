...
templates:
  - id: long_easy_v1
    description_key: daniels_long_easy_v1
    kind: long_easy
    params:
      long_mi_range: [8.0, 14.0]
  ...
  - id: long_with_strides_v1
    description_key: daniels_long_with_strides_v1
    kind: long_with_strides
    params:
      long_mi_range: [8.0, 13.0]
      strides_count_range: [4, 8]
      stride_seconds_range: [15, 25]
      stride_recovery_seconds_range: [60, 90]
    constraints:
      intensity_minutes_max: 5
    tags: [durability, economy]
```
