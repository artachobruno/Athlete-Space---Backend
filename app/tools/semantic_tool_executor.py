...
async def execute_semantic_tool(
    ...
    # action_executor imports this module (execute_semantic_tool),
    # so we import CoachActionExecutor at runtime to break the cycle
    from app.coach.executor.action_executor import CoachActionExecutor  # noqa: PLC0415
