...
from app.intelligence.runtime import CoachRuntime
...
class RegenerationTriggers:
    ...
    def maybe_regenerate_weekly_intent(
        ...
        *,
        ...
        try:
            intent = self.runtime.run_weekly_intent(user_id, athlete_id, context, previous_volume)
    ...
    def maybe_regenerate_daily_decision(
        ...
        *,
        ...
        try:
            decision = self.runtime.run_daily_decision(user_id, athlete_id, context)
