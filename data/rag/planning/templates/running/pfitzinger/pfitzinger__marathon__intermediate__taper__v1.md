...
sets:
  - session_type: easy
    templates:
      - id: easy_taper_v1
        description_key: pfitz_easy_taper_v1
  ...
  - session_type: easy_plus_strides
    templates:
      - id: strides_taper_v1
        description_key: pfitz_strides_taper_v1
  ...
  - session_type: threshold
    templates:
      - id: short_lt_touch_v1
        description_key: pfitz_short_lt_touch_v1
        kind: steady_T_block
        params: { warmup_mi_range: [2.0, 3.0], cooldown_mi_range: [1.0, 2.0], continuous_T_minutes_range: [12, 20], intensity: "LT" }
  ...
  - session_type: vo2
    templates:
      - id: vo2_touch_v1
        description_key: pfitz_vo2_touch_v1
        kind: vo2_intervals
  ...
  - session_type: long
    templates:
      - id: long_taper_v1
        description_key: pfitz_long_taper_v1
        kind: long_easy
