"""Ops summary cache (30s TTL, in-memory only)."""
...
cached_summary: OpsSummary | None = None
...
def get_cached_ops_summary() -> OpsSummary:
    """Get cached ops summary (refreshes if expired).

    Returns:
        OpsSummary (cached or fresh)
    """
