...
- Training load metrics (CTL, ATL, TSB) - computed from normalized DTL across all sports
- Short and medium-term volume
- Trends and volatility
- Contextual flags generated by rules
- Confidence score of upstream data

The metrics use unified normalization: all sports (run, bike, swim) are normalized
to the same internal unit for accurate cross-sport comparison.
