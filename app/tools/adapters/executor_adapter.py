...
async def plan_week(ctx: dict[str, Any], args: dict[str, Any]) -> dict[str, Any]:
...
async def plan_season(ctx: dict[str, Any], args: dict[str, Any]) -> dict[str, Any]:
...
async def plan_race(ctx: dict[str, Any], args: dict[str, Any]) -> dict[str, Any]:
...
async def recommend_next_session(ctx: dict[str, Any], args: dict[str, Any]) -> dict[str, Any]:
...
async def explain_training_state(ctx: dict[str, Any], args: dict[str, Any]) -> dict[str, Any]:
...
async def adjust_training_load(ctx: dict[str, Any], args: dict[str, Any]) -> dict[str, Any]:
...
async def add_workout(ctx: dict[str, Any], args: dict[str, Any]) -> dict[str, Any]:
