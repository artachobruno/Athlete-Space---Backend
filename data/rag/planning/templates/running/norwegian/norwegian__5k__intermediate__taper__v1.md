...
sets:
  - session_type: easy
    templates:
      - id: easy_taper_v1
        description_key: norwegian_easy_taper_v1
  ...
  - session_type: easy_plus_strides
    templates:
      - id: strides_taper_v1
        description_key: norwegian_strides_taper_v1
  ...
  - session_type: threshold
    templates:
      - id: reduced_threshold_touch_v1
        description_key: norwegian_reduced_threshold_touch_v1
  ...
  - session_type: vo2
    templates:
      - id: vo2_sharpen_v1
        description_key: norwegian_vo2_sharpen_v1
        kind: vo2_intervals
  ...
  - session_type: long
    templates:
      - id: long_taper_v1
        description_key: norwegian_long_taper_v1
        kind: long_easy
